...
public class RuleBasedStrategy implements Strategy {
    ...
    /**
     *
     * If I have a winning move, take it If the opoonent has a wining move,
     * block it
     *
     * @param b
     * @param p
    ...
    public boolean winningMove(Board b, Player p, int i) {
        ...
        return temp.winning(p);
    }

    /**
     * If the opponent has a move that results in two winning conditions, block
     * it
     *
     * @param b
     * @param opponent
